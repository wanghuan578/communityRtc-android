...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2019-09-19")
public class ClientLoginRes implements org.apache.thrift.TBase<ClientLoginRes, ClientLoginRes._Fields>, java.io.Serializable, Cloneable, Comparable<ClientLoginRes> {
  ...
  public java.util.List<com.spirit.community.protocol.thrift.ServiceInfo> room_gate_info; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.ROOM_GATE_INFO, new org.apache.thrift.meta_data.FieldMetaData("room_gate_info", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.spirit.community.protocol.thrift.ServiceInfo.class))));
  ...
  public ClientLoginRes(
    ...
    java.util.List<com.spirit.community.protocol.thrift.ServiceInfo> room_gate_info)
  {
    this();
  ...
  public ClientLoginRes(ClientLoginRes other) {
    ...
    if (other.isSetRoom_gate_info()) {
      java.util.List<com.spirit.community.protocol.thrift.ServiceInfo> __this__room_gate_info = new java.util.ArrayList<com.spirit.community.protocol.thrift.ServiceInfo>(other.room_gate_info.size());
      for (com.spirit.community.protocol.thrift.ServiceInfo other_element : other.room_gate_info) {
        __this__room_gate_info.add(new com.spirit.community.protocol.thrift.ServiceInfo(other_element));
      }
  ...
  public java.util.Iterator<com.spirit.community.protocol.thrift.ServiceInfo> getRoom_gate_infoIterator() {
    return (this.room_gate_info == null) ? null : this.room_gate_info.iterator();
  }

  public void addToRoom_gate_info(com.spirit.community.protocol.thrift.ServiceInfo elem) {
    if (this.room_gate_info == null) {
      this.room_gate_info = new java.util.ArrayList<com.spirit.community.protocol.thrift.ServiceInfo>();
    }
    this.room_gate_info.add(elem);
  }

  public java.util.List<com.spirit.community.protocol.thrift.ServiceInfo> getRoom_gate_info() {
    return this.room_gate_info;
  }

  public ClientLoginRes setRoom_gate_info(java.util.List<com.spirit.community.protocol.thrift.ServiceInfo> room_gate_info) {
    this.room_gate_info = room_gate_info;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ROOM_GATE_INFO:
      if (value == null) {
        ...
        setRoom_gate_info((java.util.List<com.spirit.community.protocol.thrift.ServiceInfo>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.room_gate_info = new java.util.ArrayList<com.spirit.community.protocol.thrift.ServiceInfo>(_list0.size);
                com.spirit.community.protocol.thrift.ServiceInfo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new com.spirit.community.protocol.thrift.ServiceInfo();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClientLoginRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.room_gate_info != null) {
        oprot.writeFieldBegin(ROOM_GATE_INFO_FIELD_DESC);
        {
          ...
          for (com.spirit.community.protocol.thrift.ServiceInfo _iter3 : struct.room_gate_info)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetRoom_gate_info()) {
        {
          ...
          for (com.spirit.community.protocol.thrift.ServiceInfo _iter4 : struct.room_gate_info)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.room_gate_info = new java.util.ArrayList<com.spirit.community.protocol.thrift.ServiceInfo>(_list5.size);
          com.spirit.community.protocol.thrift.ServiceInfo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new com.spirit.community.protocol.thrift.ServiceInfo();
            _elem6.read(iprot);

...
public class SessionTicket implements org.apache.thrift.TBase<SessionTicket, SessionTicket._Fields>, java.io.Serializable, Cloneable, Comparable<SessionTicket> {
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SIGNAL_SERVER((short)13, "signal_server"),
    ICE_SERVER((short)14, "ice_server");
  ...
  public java.lang.String getSignal_server() {
    return this.signal_server;
  }

  public SessionTicket setSignal_server(java.lang.String signal_server) {
    this.signal_server = signal_server;
    return this;
  }

  public void unsetSignal_server() {
    this.signal_server = null;
  }

  /** Returns true if field signal_server is set (has been assigned a value) and false otherwise */
  public boolean isSetSignal_server() {
    return this.signal_server != null;
  }

  public void setSignal_serverIsSet(boolean value) {
    if (!value) {
      this.signal_server = null;
    }
  }
  ...
  public void unsetIce_server() {
    this.ice_server = null;
  }

  /** Returns true if field ice_server is set (has been assigned a value) and false otherwise */
  public boolean isSetIce_server() {
    return this.ice_server != null;
  }

  public void setIce_serverIsSet(boolean value) {
    if (!value) {
      this.ice_server = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case SIGNAL_SERVER:
      if (value == null) {
        ...
        setSignal_server((java.lang.String)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case SIGNAL_SERVER:
      return getSignal_server();

    case ICE_SERVER:
      return getIce_server();
  ...
  public boolean isSet(_Fields field) {
    ...
    case SIGNAL_SERVER:
      return isSetSignal_server();
    case ICE_SERVER:
      return isSetIce_server();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(SessionTicket that) {
    ...
    boolean this_present_signal_server = true && this.isSetSignal_server();
    boolean that_present_signal_server = true && that.isSetSignal_server();
    if (this_present_signal_server || that_present_signal_server) {
      if (!(this_present_signal_server && that_present_signal_server))
        return false;
      if (!this.signal_server.equals(that.signal_server))
        return false;
    }

    boolean this_present_ice_server = true && this.isSetIce_server();
    boolean that_present_ice_server = true && that.isSetIce_server();
    if (this_present_ice_server || that_present_ice_server) {
      if (!(this_present_ice_server && that_present_ice_server))
        return false;
      if (!this.ice_server.equals(that.ice_server))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSignal_server()) ? 131071 : 524287);
    if (isSetSignal_server())
      hashCode = hashCode * 8191 + signal_server.hashCode();

    hashCode = hashCode * 8191 + ((isSetIce_server()) ? 131071 : 524287);
    if (isSetIce_server())
      hashCode = hashCode * 8191 + ice_server.hashCode();
  ...
  public int compareTo(SessionTicket other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSignal_server()).compareTo(other.isSetSignal_server());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSignal_server()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.signal_server, other.signal_server);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.valueOf(isSetIce_server()).compareTo(other.isSetIce_server());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIce_server()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ice_server, other.ice_server);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class SessionTicketStandardScheme extends org.apache.thrift.scheme.StandardScheme<SessionTicket> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SessionTicket struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 13: // SIGNAL_SERVER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.signal_server = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SessionTicket struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.signal_server != null) {
        oprot.writeFieldBegin(SIGNAL_SERVER_FIELD_DESC);
